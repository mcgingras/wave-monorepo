...
const identifierByAddressByChainId = mapValues(
  (addressByIdentifier: any) => mirror(addressByIdentifier),
...
export const resolveIdentifier = (chainId: number, identifier: any) => {
  // @ts-ignore
...
export const resolveAddress = (chainId: number, address: any) => {
  const identifier =
